...
const dbConfig = {
  ...
  user: process.env.DB_USERNAME || (usernameDB ?? 'services_bb_cata_db_u'),
  password: process.env.DB_PASSWORD || (pswdDB ?? 'bb_cata_db_u_pswd'),
  name: process.env.DB_DATABASE || (nameDB ?? 'services_cata_db'),
