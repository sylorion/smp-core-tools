 ...
 * import { consumerConfigReviewComment } from './config';
 *
 * // Iterating over configuration to setup consumers
 * for (const [microservice, entities] of Object.entries(consumerConfigReviewComment)) {
 ...
 */
const consumerConfigReviewComment = {
    organization: {
      organization: {
  ...
  export { consumerConfigReviewComment };
